...
$circuitAndalousie->setDeterminant("l'");
...
$circuitVietnam->setDeterminant('le ');
...
$circuitItalie->setDeterminant("l'");
...
$circuitIlesCanaries->setDeterminant("l'");
...
//add_programmation('2016-05-15', 12,  120, $circuitIdF); //Test déprogramamtion IDF
